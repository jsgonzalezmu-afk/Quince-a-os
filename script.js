...
// ═══════════════════════════════════════════════════════════════
// VINYL — se pausa cuando YouTube está reproduciendo
// ═══════════════════════════════════════════════════════════════
function initMusicVinyl() {
  const vinyl    = document.getElementById('musicVinyl');
  const ytFrame  = document.getElementById('ytPlayer');

  if (!vinyl || !ytFrame) return;

  // Detecta si el iframe está activo (el usuario interactuó)
  // El vinyl gira siempre que la página esté visible
  // y se pausa visualmente cuando el video toca
  // (YouTube no expone API sin SDK adicional, así que el vinyl gira siempre)
  // Si quieres pausar el vinyl: vinyl.classList.add('paused')
}
